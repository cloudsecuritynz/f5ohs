...
* Basic and Token authentication can be used. If using basic, access to bash via API (used for uptime, NTP status, disk usage and DNS calls with dig) will require an admin account be used. [An overview of iControl permissions is here.](https://support.f5.com/csp/article/K84925527)
